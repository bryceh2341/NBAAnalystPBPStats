...
with open('pbpstats 2020-2021 Team Data Defense.csv') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
...
plt.title('Offensive Rating vs. Shot Quality 2020-2021')
...
# giving a title to my graph 
plt.title('Defensive Rating vs. Shot Quality 2020-2021')
# function to show the plot
plt.show()  
